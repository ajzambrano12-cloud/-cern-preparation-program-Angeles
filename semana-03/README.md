...
Enfoque en el análisis directo de datos de física de partículas mediante el formato optimizado **NanoAOD** y la librería `uproot`, ejecución de flujos de trabajo colaborativos en GitHub (ramas de desarrollo, resolución de conflictos y revisión por pares mediante Pull Requests) y diseño del primer borrador de CV técnico internacional en formato Europass en inglés.
...
* `evidencias/`: Documentación técnica de las prácticas, cuestionarios y el CV técnico.
