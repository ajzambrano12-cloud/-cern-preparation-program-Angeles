# Módulo 4 — Perfil Internacional y Contribución Open Source

**Período:** 21 al 25 de septiembre de 2026  
**Dedicación estimada:** 6 horas (trabajo autónomo y sesión guiada)

---

### Descripción del módulo
Enfoque en la inserción en proyectos de código abierto (*Open Source*), el dominio del modelo *Forking Workflow* en GitHub, la comprensión de los requerimientos y etapas de postulación al *CERN Summer Student Programme*, y la optimización del perfil profesional en LinkedIn para convocatorias científicas y tecnológicas internacionales.
...
* `ejercicios/`: Scripts, notas y enlaces a repositorios bifurcados.
* `evidencias/`: Documentación técnica de las contribuciones Open Source y perfiles profesionales.
